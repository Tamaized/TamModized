...
public class EntityDragonPartOld extends Entity {
	/** The entity entity this entity part belongs to */
	...
	public boolean attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_) {
		return this.isEntityInvulnerable(p_70097_1_) ? false : this.entityDragonObj.attackEntityFromPart(this, p_70097_1_, p_70097_2_);
	}
