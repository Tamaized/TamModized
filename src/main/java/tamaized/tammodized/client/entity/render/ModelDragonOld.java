...
public class ModelDragonOld extends ModelBase {
	/** The head Model renderer of the entity */
	private final ModelRenderer head;
	/** The spine Model renderer of the entity */
	private final ModelRenderer spine;
	/** The jaw Model renderer of the entity */
	private final ModelRenderer jaw;
	/** The body Model renderer of the entity */
	private final ModelRenderer body;
	/** The rear leg Model renderer of the entity */
	private final ModelRenderer rearLeg;
	/** The front leg Model renderer of the entity */
	private final ModelRenderer frontLeg;
	/** The rear leg tip Model renderer of the entity */
	private final ModelRenderer rearLegTip;
	/** The front leg tip Model renderer of the entity */
	private final ModelRenderer frontLegTip;
	/** The rear foot Model renderer of the entity */
	private final ModelRenderer rearFoot;
	/** The front foot Model renderer of the entity */
	private final ModelRenderer frontFoot;
	/** The wing Model renderer of the entity */
	private final ModelRenderer wing;
	/** The wing tip Model renderer of the entity */
	...
	/**
	 * Updates the rotations in the parameters for rotations greater than 180 degrees or less than -180 degrees. It adds or subtracts 360 degrees, so that the appearance is the same, although the numbers are then simplified to range - 180 to 180
	 */
